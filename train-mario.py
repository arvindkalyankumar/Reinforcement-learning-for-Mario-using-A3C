...
parser.add_argument('--num-steps', type=int, default=2000,
                    help='number of forward steps in A3C (default: 2000)')
...
if __name__ == '__main__':
    ...
    # done_event = mp.Event()
    # queue.put(model)
    # p = mp.Process(target=run_rl_solver, args=(queue, done_event))
    # p.start()
    ...
    print (color.BLUE + "No of processes : {}".format(mp.cpu_count()) + color.END) 
